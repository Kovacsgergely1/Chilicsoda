...
<body>
    ...
    <?php
        ...
        foreach($_SESSION["cart"] as $current_item_id => $quantity){
            ...
            //kép + név
            echo "<img src='data:image/png;base64," . base64_encode($product["product_image"]) . "' style='width: 50px;'>";  //!!! itt beállítottam a képnek egy szélességet, vigyázz, nehogy szopj vele
