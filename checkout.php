<?php
    ...
    if(isset($_POST["order"]) && count($_SESSION["cart"]) != 0){
        ...
        <br>Összesen: " . $_SESSION["total"] . "Ft
        <br>Köszönjük a rendelést és a belénk fektetett bizalmat!
        <br>Chilicsoda<br>1234 Kiskutya<br>Kismacska út 1.<br>Ha kérdése van írjon: info@chilicsoda.hu";
...
<div id="Sidenav" class="sidenav">
    ...
    <div class="headbar">
        ...
        <a href="webshop.php"><img class="logo" src="./chilixd.png" alt="Logo_helye"></a>
    </div>



    <h2 style='margin-left: 2%; margin-top: 1%;'>Termékek:</h2> <br><br>
    <form action="checkout.php" method="post"><div class='margin-left'>
    <?php
        ...
        foreach($_SESSION["cart"] as $current_item_id => $quantity){
            ...
            //kép + név
            echo "<img src='$image' style='width: 300px; border-radius: 5px;'>";  //!!! itt beállítottam a képnek egy szélességet, vigyázz, nehogy szopj vele
            ...
            //törlés
            echo "<br><input type='submit' name='d-" . $current_item_id . "' value='Törlés' id='torles'>";
            echo "<br><br><br><br>";

        }

        echo "<b>Összesen: </b><i>" . $_SESSION["total"] . " Ft </i><br><br>";

        // !!!
        echo "<b>Szállítási adatok:</b> <br>";
    ...
    <form action="checkout.php" method="post">
        <br>
        <input type="submit" name="order" value="Megrendelés" id="order">
    </form>
</body>
</html>